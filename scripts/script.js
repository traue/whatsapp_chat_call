...
const countries = [
    ...
    selected_option = document.querySelector('.content div');
...
for (country of countries) {
    ...
    <li class="option">
        ...
        <strong>+<b>${country.phone}</b></strong>
    </li> `;
...
function selectOption() {
    ...
    const icon = this.querySelector('.iconify').cloneNode(true),
        phone_codeplus = this.querySelector('strong').cloneNode(true),
        phone_code = this.querySelector('b').cloneNode(true);

    selected_option.innerHTML = '';
    selected_option.append(icon, phone_codeplus);
